...
<svg
	...
	<g
		...
		<text
		   ...
		   font-size="110"
		   id="triangleSymbol01"
		   style="font-size:110px;font-family:Verdana;text-anchor:middle;fill:#008000"><?php echo $sym01; ?></text>
		<text
		   x="210"
		   y="95"
		   font-size="110"
		   id="triangleSymbol02"
		   style="font-size:110px;font-family:Verdana;text-anchor:middle;fill:#000000"><?php echo $sym02; ?></text>
		<text
		   x="345"
		   y="250"
		   font-size="110"
		   id="triangleSymbol03"
		   style="font-size:110px;font-family:Verdana;text-anchor:middle;fill:#0000ff"><?php echo $sym03; ?></text>
		<text
		   x="210"
		   y="370"
		   font-size="110"
		   id="triangleSymbol04"
		   style="font-size:110px;font-family:Verdana;text-anchor:middle;fill:#008000"><?php echo $sym04; ?></text>
		<text
		   x="210"
		   y="240"
		   font-size="110"
		   id="triangleSymbol05"
		   style="font-size:110px;font-family:Verdana;text-anchor:middle;fill:#000000"><?php echo $sym05; ?></text>
	</g>
</svg><?php
}; // ends function
 ...
 * Proof of concept
 */
drawPyramid("red","#fff","orange","red","white", $sagitaurus, $spirit, $mercury , $fire, "D" );
?>
